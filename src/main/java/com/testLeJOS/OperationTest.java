...
public class OperationTest {
	...
	@Test
	/**
	 * On vérifie que l'ajout d'une tache à une opération s'effectue correctement
	 */
	...
	@Test
	/**
	 * On vérifie que la suppression d'une tâche à une opération s'effectue correctement
	 */
